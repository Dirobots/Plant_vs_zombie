# Plant vs Zombie – Automated basil Growing System

## Overview

**Plant vs Zombie** is a project focused on optimizing the growth of a **Basil plant** through a set of automated systems. Rather than relying on manual care, the project leverages sensors, actuators, and control algorithms to create the ideal growing environment for the plant at all times.
...
### 💧 Humidity Detection
Humidity sensors continuously measure the ambient relative humidity around the plant. The readings are used to trigger ventilation or misting systems to keep humidity within the optimal range for basil growth.

### 💡 Smart Lighting
Automated lighting adjusts the intensity and duration of light exposure based on the plant's current growth stage and the ambient light level. This ensures the basil receives sufficient photosynthetically active radiation (PAR) throughout the day, even in low-light environments.
...
- Maximize basil yield and quality through consistent, data-driven care.
